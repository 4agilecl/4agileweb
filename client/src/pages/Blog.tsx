...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Estrategias para encontrar y atraer perfiles especializados como Data Scientist, DevOps y Arquitectos Cloud en el competitivo mercado chileno.",
    image:
  ...
  },
  {
    ...
    title:
      "Outsourcing TI en Chile: Cómo escalar equipos de Data, DevOps y Ciberseguridad",
    excerpt:
      "El outsourcing permite a las empresas en Chile escalar ágilmente sus áreas técnicas críticas sin los cuellos de botella de la contratación tradicional.",
    image:
