...
const articlesContent: Record<string, { title: string; image: string; content: React.ReactNode }> = {
      ...
      <main>
        <article className="container" style={{ padding: '120px 0 80px', maxWidth: '800px' }}>
          ...
          <img 
            src={article.image} 
            alt={article.title} 
            style={{ width: '100%', height: 'auto', maxHeight: '400px', objectFit: 'cover', borderRadius: '16px', marginBottom: '3rem' }} 
          />
